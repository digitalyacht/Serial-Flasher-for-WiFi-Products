...
Download and extract the "Serial Flasher for WiFi Products Web App Vx-x-x.zip" file included in this repo and then double click on the index.html file and you should see the web app landing page...
